...
import SpriteAnimation, { buildEquipmentOverlays } from '../ui/SpriteAnimation';
...
import { showTooltip, hideTooltip, updateTooltipPosition } from '../ui/GameTooltip';
...
import BubbleEmitter from '../ui/BubbleEmitter';
...
export default function BattleScreen() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        position: 'absolute', top: 0, left: 0, right: 0, height: '8%', minHeight: 44, maxHeight: 64,
      ...
      <div style={{
        position: 'absolute', top: '8%', left: 0, right: 0, bottom: '26.2%',
      ...
      <div style={{
        position: 'absolute', bottom: 0, left: 0, right: 0, height: '26.2%',
