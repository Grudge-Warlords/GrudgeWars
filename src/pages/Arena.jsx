  ...
  return (
    <div className="game-container">
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16, background: 'radial-gradient(ellipse at 50% 30%, #0a1128, #050a18)' }}>
        <h1 style={{ fontFamily: "'Cinzel', serif", fontSize: 'clamp(2rem, 5vw, 3rem)', color: '#06b6d4', letterSpacing: '3px', textShadow: '0 0 30px #06b6d444' }}>GRUDGE ARENA</h1>
        <p style={{ color: '#94a3b8', maxWidth: 500, textAlign: 'center' }}>3D combat arena. Fight for glory.</p>
