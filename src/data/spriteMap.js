...
export const enemySpriteMap = {
  ...
  dark_mage: fishEnemySprite('fish_purple'),
  dark_knight: fishEnemySprite('fish_blue'),
  shadow_warrior: fishEnemySprite('fish_crimson'),
  water_priestess_mage: fishEnemySprite('fish_teal'),
  orc: fishEnemySprite('fish_gold'),
  dragon_whelp: fishEnemySprite('fish_green'),
  ...
  mimic: fishEnemySprite('fish_tan'),
  crow_knight: fishEnemySprite('fish_blue'),
  stone_guardian: fishEnemySprite('fish_dark'),
  forest_guardian: fishEnemySprite('fish_green'),
  elite_orc: fishEnemySprite('fish_crimson'),
  lich: killerFishSprite,
  demon_lord: { ...killerFishSprite, filter: 'hue-rotate(30deg) saturate(1.4) brightness(1.1)' },
  evil_wizard: { ...killerFishSprite, filter: 'hue-rotate(270deg) saturate(1.3) brightness(1.1)' },
  void_king: { ...killerFishSprite, filter: 'hue-rotate(180deg) saturate(1.5) brightness(1.2)' },
  water_elemental: { ...killerFishSprite, filter: 'hue-rotate(160deg) saturate(1.4) brightness(1.1)' },
  nature_elemental: { ...killerFishSprite, filter: 'hue-rotate(90deg) saturate(1.3) brightness(1.1)' },
  grand_shaman: fishEnemySprite('fish_green'),
  canyon_warlord: fishEnemySprite('fish_crimson'),
  ...
  void_sentinel: { ...killerFishSprite, filter: 'hue-rotate(200deg) saturate(1.5) brightness(1.1)' },
  abyssal_demon: { ...killerFishSprite, filter: 'hue-rotate(350deg) saturate(1.6) brightness(1.0)' },
  eldritch_horror: { ...killerFishSprite, filter: 'hue-rotate(120deg) saturate(1.3) brightness(0.8)' },
  ...
  medieval_warrior: fishEnemySprite('fish_gold'),
  fantasy_warrior: fishEnemySprite('fish_crimson'),
};
