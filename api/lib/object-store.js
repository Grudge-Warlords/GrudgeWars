...
export const DATASETS = [
  ...
  // Canonical race × class 2D character sprite manifest — one sheet per
  // (race, class) combination, built from GRUDA-Wars' spriteMap via
  // scripts/generate-hero-character-sprite-manifest.mjs. Any Grudge 2D game
  // can consume this to render heroes consistently.
  'heroCharacterSprites',
];
